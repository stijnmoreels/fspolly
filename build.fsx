...
let summary = "F# retry functionality package inspired by the C# Polly library"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "F# retry functionality package inspired by the C# Polly library. This package allows you to write more cleaner retry-code in a functional style, supporting various kinds of retry functionality such as Linear/Exponential Backoff, Circuit Broker..."

// List of author names (for NuGet package)
let author = "Stijn Moreels"

// Tags for your project (for NuGet package)
let tags = "fsharp functional retry polling backoff linear-backoff exponential-backoff circuit-broker"

// File system information
let solutionFile  = "fspolly.sln"
...
let gitHome = sprintf "%s/%s" "https://github.com/stijnmoreels/fspolly" gitOwner

// The name of the project on GitHub
let gitName = "fspolly"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/stijnmoreels"
...
let info =
  [ "project-name", "fspolly"
    "project-author", "Stijn Moreels"
    "project-summary", "F# retry functionality package inspired by the C# Polly library"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/fspolly" ]
